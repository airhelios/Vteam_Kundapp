  ...
  return (
        ...
        <ul className="my-4 space-y-3">
            ...
            <div>Rent status: {beingRented.toString()}</div>
                    ...
                    { 
                        bikeId.length >= 5 ? <RentButton bikeId={bikeId} shortId={true} /> : ""
                    }
            </li>
            { !isLoggedIn &&
                (<li>
                    <button type="submit" onClick={(e) => loginUser(e)} className="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                        ...
                        <span className="flex-1 ms-3 whitespace-nowrap">Logga In</span>
                    </button>
                </li>
                )
            }
            ...
            <li>
                <Link to="/map/Uppsala" className="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
            ...
            <li>
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Avsluta färd</span>
                </a>
            </li>

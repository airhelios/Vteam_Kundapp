...
export default function Logout() {
  ...
  return (
        <div data-testid="logout-test" className="flex items-center justify-center p-3 text-base font-bold text-red-500 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
            <a href="#" onClick={(e) => logOutUser(e)} className="flex items-center gap-1 text-xs font-normal text-red-500 hover:underline dark:text-gray-400">
